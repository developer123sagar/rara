...
import { BloodGroup, Search } from "@/types";
import PDFViewer from "@/common/PDFViewer";
import { Footers } from "..";
import toast from "react-hot-toast";

export default function Add_Rider(props: Search) {
  ...
  const bloodGroupOpt = ["A+", "A-", "B+", "B-", "AB+", "AB-", "O-", "O+"];
  return (
    <>
      <HeaderWithSearch
      ...
      <main className="lg:pt-30 r-2xl:pt-0 lg:mt-20 lg:px-10 px-1">
        ...
        <form className="mt-6">
          ...
          <div className="flex flex-col lg:flex-row flex-wrap justify-between gap-8 mt-4">
            <EditInput
              label="Full Name"
              basis={48}
              value={form.name}
          ...
          <div className="my-16">
            ...
            <div>
              ...
              <div className="flex flex-col lg:flex-row flex-wrap justify-between gap-8 mt-2">
                <EditInput
                  label="City"
                  basis={48}
          ...
          <div className="my-16">
            ...
            <div className="flex flex-col lg:flex-row flex-wrap justify-between gap-8 mt-4">
              ...
              <div className="w-full flex flex-col lg:flex-row justify-between gap-8">
                <div className="w-full lg:basis-[48%] flex flex-col ">
                  <label className="text-sm font-semibold text-black">
                    Issued Date
                  </label>
                  <input
            ...
            <div className="w-full flex flex-col lg:flex-row gap-5 justify-between mt-6">
              <div className="flex justify-between">
                <div>
                  <div className="h-[2px] w-full mt-[30px] mb-6">
                    <span className="relative -top-[20px] inline-block py-[10px]  text-sm font-semibold text-black mb-2">
