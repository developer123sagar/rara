...
const Footer = () => {
  return (
    <>
      <footer className="bg-black lg:grid lg:grid-cols-5 sm:mt-20">
        ...
        <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
          ...
          <div className="mt-12 border-t border-gray-100 pt-12">
            <div className="sm:flex sm:items-center sm:justify-between">
              ...
              <div className="relative text-center w-[180px] h-[180px] flex flex-col items-center">
                <img
                  src="/silicon.png"
